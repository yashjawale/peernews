...
try {
  ...
  $stmt = $pdo->query("SELECT posts.*, users.name as user_name FROM posts JOIN users ON posts.user_id = users.id WHERE posts.id = {$_GET['id']}");
  $post = $stmt->fetch();
...
<main class="container mx-auto px-6 py-20">
  <div class="md:w-11/12 lg:w-8/12">
    ...
    <div class="py-8">
      ...
      <img src="/peernews/uploads/<?= $post['image'] ?>" alt="Placeholder" class="w-full h-[400px] mt-8 rounded-xl object-cover object-center">
